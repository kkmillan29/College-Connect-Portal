...
<Br>
  <p align="center"><?php echo $succe;?></p>
     ...
     <font size="+2"><center>APPOINMENTS(Guest) WITH PRINCIPLE</center></font>
<iframe src="gappt.php" class="form-control3"
  ...
  <a href="gview.php">    <td align="left" bgcolor="#FFFFFF"><input type="submit" class="btn btn-embossed btn-success" name="clear" value="Appoinment Manager" id="Submit" /></td></a></center>
