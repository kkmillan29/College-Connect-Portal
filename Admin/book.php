...
mysqli_query($con,"INSERT INTO notification VALUES ('0', '$title',now(),'$desc')");
...
<title>College Notification</title>
      ...
      <table id="fortemp" width="600" align="center" class="tile" cellpadding="8" cellspacing="0">
        <form action="book.php" method="post" enctype="multipart/form-data">
          ...
          <tr>
            <td bgcolor="#FFFFFF">
<p></p>
            <td align="left" bgcolor="#FFFFFF"><input type="submit" class="btn btn-embossed btn-success" name="Submit" value="Submit Notification" id="Submit" /> </form> <align="left" bgcolor="#FFFFFF"><a href="clearclg.php"><input type="submit" class="btn btn-embossed btn-success" name="Submit" value="Clear or Update College Notification" id="Submit" /></a>
