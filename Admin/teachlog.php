...
<title>Admin Type: Teacher</title>
...
<div align="center">
  ...
  <center><font size="4"><b>Administration Type: Faculty</center></b></font>
<table id="fortemp" width="400" align="center" cellpadding="6" style="background-color:#FFF; border:#666 1px solid;">
  <form action="teachconfig.php" method="post"  name="signinform" id="signinform">
    <tr>
    </tr>

    <tr>
      <td width="21%"><strong>User ID:</strong></td>
 ...
 <td>
 <a href="teachregister.php"><input id="register" type="submit" name="register" value="Register"></a></td>
