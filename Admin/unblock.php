...
$sql = mysqli_query($con,"UPDATE `svceconnect`.`student` SET `blocked` = '0' WHERE `student`.`Reg_No` = '$usn'");
echo "<h4><strong>Account Unblocked Successfully</strong></h4>"; 
}
}
...
<Br>
  <p align="center"><?php echo $succe;?></p>
      <table id="fortemp" width="600" align="center" class="tile" cellpadding="8" cellspacing="0">
        <form action="unblock.php" method="post" enctype="multipart/form-data">
          <?php print $errorMsg; ?> 
     ...
     <td width="114" bgcolor="#FFFFFF"><div align="left">Student USN:<span class="brightRed"> *</span></div></td>
            ...
            <td bgcolor="#FFFFFF">
<p></p>
            <td align="left" bgcolor="#FFFFFF"><input type="submit" class="btn btn-embossed btn-success" name="Submit" value="Unblock Student Account" id="Submit" /> <align="left" bgcolor="#FFFFFF">
</form>
