...
mysqli_query($con,"DELETE FROM `svceconnect`.`ppt` WHERE `ppt`.`aid` = '$asid'");
$files=glob("../ppts/$asid/*");
...
$succmsg='PPT ID:<font color="red">'.$asid.'</font> Deleted successfully';
}
}
  ...
  <tr>
    <td width="738" valign="top">
      <table id="fortemp" width="600" align="center" cellpadding="8" cellspacing="0" style="border:#999 1px solid; background-color:#FBFBFB;">
        <form action="pptclear.php?aid=<?php echo $id;  ?>" method="post" enctype="multipart/form-data">
          <tr>
