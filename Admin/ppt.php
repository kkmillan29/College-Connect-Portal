...
// $b_publisher =$_POST['b_publisher']; // filter everything but letters and numbers
 ...
 $errorMsg="";
     ...
     if ((!$sub)||(!$asid)||(!$b_name)||(!$b_author) || (!$sec)||(!$sem)||(!$branch)) { 
    ...
    if(!$sub){ 
       ...
       if(!$asid){ 
       $errorMsg .= ' * Please Enter PPT ID<br />';
     }  
     if(!$b_name){ 
...
mysqli_query($con,"INSERT INTO ppt VALUES('$asid','$b_name','$b_author','$sec','$sem','$branch','$sub','$name')");
$id = mysql_insert_id();
mkdir("../ppts/$asid", 0755);
...
if ($_POST['parse_var'] == "pic"){
	...
	if ($_FILES['fileField']['tmp_name'] != "") { 
            ...
            if($_FILES['fileField']['size'] > $maxfilesize ) { 
            ...
            } else if (!preg_match("/\.(ppt|pptx)$/i", $_FILES['fileField']['name'] ) ) {
				      ...
				      unlink($_FILES['fileField']['tmp_name']); 
                        ...
                        $newname =$asid.".ppt";
                        $place_file = move_uploaded_file( $_FILES['fileField']['tmp_name'], "../ppts/$asid/".$newname);
...
$succmsg='PPT Submitted successfully<br>Kindly Please Note your PPT ID:<font color="red">'.$asid.'</font>';
}
  ...
  <tr>
    <td width="738" valign="top">
      <table id="fortemp" width="600" align="center" cellpadding="8" cellspacing="0" style="border:#999 1px solid; background-color:#FBFBFB;">
        <form action="ppt.php?aid=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
          <tr>
            <td align="left" colspan="2"><?php print $errorMsg; ?>			</td>
          </tr>
           <tr>

            <td width="114" bgcolor="#FFFFFF"><div align="left"> Subject:<span class="brightRed"> </span></div></td>
     ...
     <tr>
            ...
            <td width="114" bgcolor="#FFFFFF"><div align="left"> PPT ID:<span class="brightRed"> </span></div></td>
            <td width="452" bgcolor="#FFFFFF"><div align="left">
          ...
          <tr>
            ...
            <td width="452" bgcolor="#FFFFFF"><div align="left">
              <input name="b_name" type="text" class="formFields" id="b_name" value="" size="32" placeholder="ex: DSA PPT" maxlength="20" />
              <span id="nameresponse"><span class="textSize_9px"><span class="greyColor">Alphanumeric Characters Only</span></span></span></div></td>
          </tr>
          <tr>
            <td bgcolor="#FFFFFF"><div align="left">Description:<span class="brightRed"> </span></div></td>
            <td bgcolor="#FFFFFF"><div align="left">
              <input name="b_author" type="text" class="formFields" id="b_author" value="" size="32" placeholder="ex:DSA Notes 1Module" maxlength="20" />
          ...
          <tr>
            ...
            <td bgcolor="#FFFFFF"><div align="left">
             Only PPTX File Select (Upto 100MB)<input name="fileField" type="file" class="formFields" id="fileField" size="42" />
             <br>
...
<a href="pptclear.php?aid=<?php echo $id; ?>"><input type="submit" name="Submit" value="Delete PPT" id="Submit" /></a><br>
  </td></center>
</table>
