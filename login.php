...
if($block=="1"){
  ...
  $errorMSG="Sorry you have been Blocked by Admin!!";
}
else{
...
$errorMSG='<br>You Havnt Activated Your Account!<a href="activate.php?Reg_No='.$id.'">Activate Now</a>';
...
// Print login failure message to the user and link them back to your login page
$errorMSG="<br>Oops,Wrong Id or Password Try Again!";
          ...
          <div class="login-form">
            ...
            <input type="submit" name="submit" class="btn btn-primary btn-lg btn-block" href="#" value="Login In!">
						...
						<div class="login-link">
                         <a href="forgot.php">Forgot Password?</a> <Br>     <a href="guest.php">Book Appoinment As Guest</a></div>
          </div>
        </form>
        </div>
      </div>
