...
?>
  ...
  <center><h4>Results For Students</h4></center><br>
<CENTER><a href="1ia.php"><input type="submit" name="result" id="submit" class="col-xs-10" value="I IA" ></a><bR><br>
<a href="2ia.php"><input type="submit" name="submit" id="submit" class="col-xs-10" value="II IA" /></a><br><br>
<a href="ext.php"><input type="submit" name="submit" id="submit" class="col-xs-10" value="EXTERNAL" /></a><br><br>
</CENTER>
  <div class="row">
