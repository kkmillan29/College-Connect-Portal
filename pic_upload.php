...
<h3>       Upload or replace your profile image here <br />  
      ...
      <form action="pic_upload.php?Reg_No=<?php echo $id; ?>" method="post" enctype="multipart/form-data" name="form" id="form" onsubmit="return validate_form ( );">
         <tr>
           <td colspan="2"><img src="Students/<?php echo "$id"; ?>/pic1.jpg" alt="" width="150" /></td>
         </tr>
		 <tr>
