...
?>
  ...
  <?php
// Query member data from the database and ready it for display
$sql = mysqli_query($con,"SELECT * FROM result WHERE usn='$id' AND sem='$sem' AND branch='$branch' AND type='2IA' LIMIT 1");
...
?>
  ...
  <center><h4>Results For Students of II(IA)</h4></center><br>
